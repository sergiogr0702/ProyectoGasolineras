...
class Form1(Layout):
    ...
    def print_result_on_text(self, gasolineras):
        ...
        for gasolinera in gasolineras:
            ...
            textbox.insert("0.0", "Longitud: " + str(gasolinera.loc['coordinates'][1]) + "\n")
            textbox.insert("0.0", "Latitud: " + str(gasolinera.loc['coordinates'][0]) + "\n")
            ...
            textbox.insert("0.0", "Localidad: " + gasolinera.localidad + "\n")
